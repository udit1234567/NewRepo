...
namespace AIA.Life.Repository.AIAEntity
{
    ...
    public partial class tblProductRiderParameter
    {
        public int RiderParameterMapId { get; set; }
        ...
        public Nullable<int> ProductRiderId { get; set; }
        public string ApplyOnTo { get; set; }
    
        public virtual tblRider tblRider { get; set; }
        public virtual tblRider tblRider1 { get; set; }
    }
}
