    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (a >= 462) {
                ...
                content.attr('style', 'min-height:'+imgHeight+'px');
            }
            else {
                content.attr('style', 'min-height:' + imgHeight + 'px');
            }
            ...
            if (bodyWidth <= 480) {
                ...
                $('.bg-img').css({'width':(bodyWidth - 30) + "px",'height':(imgHeight+"px")});
                content.attr('style', 'min-height:' + imgHeight + 'px');
            }
            else if(bodyWidth>=480 && bodyWidth<=920){
                imgHeight = imgHeight;
                $('.bg-img').css('width', (bodyWidth)+"px");
                content.attr('style', 'min-height:' + imgHeight + 'px');
            }
